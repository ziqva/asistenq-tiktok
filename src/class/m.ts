...
var cp: any // Recording process

// returns a Readable stream
exports.start = function (options: any) {
  ...
  var defaults = {
    ...
    verbose: false,
    recordProgram: 'sox',
    program: "C:\\Program Files (x86)\\sox-14-4-2\\sox.exe"
  }
  ...
  switch (options.recordProgram) {
    ...
    // instead of "rec"
    case 'sox':
      cmd = options.program || defaults.program
      audioType = "wav"
